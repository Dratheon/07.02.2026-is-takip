                  ...
                  {form.roles.length > 0 && (
                    <div style={{ marginTop: 16 }}>
                      <div style={{ fontWeight: 600, fontSize: 13, marginBottom: 8, color: '#92400e' }}>
                        📎 İş Kollarına Göre Belge Yükleme (Opsiyonel)
                      </div>
                      ...
                      {form.roles.map((role) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap' }}>
                              {[
                                { type: 'olcu', label: '📐 Ölçü', color: '#3b82f6' },
                                { type: 'teknik', label: '📏 Teknik', color: '#8b5cf6' },
                                { type: 'sozlesme', label: '📄 Sözleşme', color: '#10b981' },
                                { type: 'montaj', label: '🏗️ Montaj', color: '#f59e0b' },
                              ].map((docType) => (
                                <label
                                  key={docType.type}
                                  style={{
                ...
                <input
                  ...
                  {form.roles.length === 0 && (
                    <div style={{ marginTop: 16, padding: 12, background: '#fef3c7', borderRadius: 8, fontSize: 12, color: '#92400e' }}>
                      ⚠️ Belge yüklemek için önce iş kollarını seçin.
                    </div>
                  )}
                </div>
              )}
...
const STATUS_LABELS = {
  ...
  'TESLIME_HAZIR': { label: 'Teslime Hazır (Demonte)', tone: 'info', icon: '📦' },
  // Finans statüleri
  ...
  'FIYAT_SORGUSU_BEKLIYOR': { label: 'Fiyat Sorgusu - Karar Bekliyor', tone: 'warning', icon: '⏳' },
  'FIYAT_SORGUSU_ONAY': { label: 'Fiyat Sorgusu - Onaylandı', tone: 'success', icon: '✅' },
  'FIYAT_SORGUSU_RED': { label: 'Fiyat Sorgusu - Reddedildi', tone: 'danger', icon: '❌' },
};
