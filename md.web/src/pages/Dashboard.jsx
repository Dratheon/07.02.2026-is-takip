    ...
    switch (widgetId) {
        ...
        return (
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 16 }}>
            <div className="widget-stat">
              <div className="widget-stat-icon primary">📋</div>
            ...
            <div className="widget-stat">
              <div className="widget-stat-icon success">📈</div>
              <div className="widget-stat-content">
            ...
            <div className="widget-stat">
              <div className="widget-stat-icon info">👥</div>
              <div className="widget-stat-content">
            ...
            <div className="widget-stat">
              <div className="widget-stat-icon warning">📅</div>
              <div className="widget-stat-content">
      ...
      case 'stockAlerts':
        ...
        if (criticalItems.length === 0) {
          return <div className="widget-empty"><div className="widget-empty-icon">✅</div><div className="widget-empty-text">Kritik stok yok</div></div>;
        }
        return (
            ...
            {criticalItems.slice(0, 5).map((item, idx) => (
              <Link key={idx} to="/stok/kritik" className="widget-list-item">
                <div className="widget-list-item-left">
                  <div className="widget-list-item-icon" style={{ background: 'var(--color-danger-bg)', color: 'var(--color-danger)' }}>⚠️</div>
      ...
      case 'recentActivities':
        ...
        if (activities.length === 0) {
          return <div className="widget-empty"><div className="widget-empty-icon">📋</div><div className="widget-empty-text">Son aktivite yok</div></div>;
        }
        return (
          <div className="widget-list">
            {activities.map((act, idx) => (
              <Link key={idx} to={`/isler/list?job=${act.id}`} className="widget-list-item">
                <div className="widget-list-item-left">
                  <div className="widget-list-item-icon">📋</div>
                  <div className="widget-list-item-content">
    ...
    <div>
      ...
      <div className="dashboard-header">
        ...
        <div className="dashboard-actions">
          ...
          >
            {editMode ? '✓ Duzenlemeyi Bitir' : '⚙️ Duzenle'}
          </button>
          {editMode && (
            <>
        ...
        <div className="widget-picker">
          {filteredDefinitions.map((def) => {
            ...
            return (
              ...
              >
                <div className="widget-picker-icon">{def.icon}</div>
